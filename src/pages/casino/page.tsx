    ...
    <div id="section-overview" className="bg-white rounded-lg shadow-md p-6 md:p-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
        ...
        <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
          ...
          <div className="text-lg font-bold text-gray-900">{casino.monthlyPlayers}</div>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
          ...
          <div className="text-lg font-bold text-gray-900">{casino.minWithdrawal}</div>
        </div>
      </div>
...
export default function CasinoReviewPage() {
  ...
  const comingSoonCasinoMap: Record<string, {
    ...
    ace96au: { name: 'ACE96AU', logo: '/casinos/ace96au.png', rating: 4.85, ratingCount: 512, tag: 'New Launch', bonusLabel: 'VIP Bonus', bonus: '100% VVIP Bonus', payoutTime: 'Instant', withdrawLimit: 'A$12,000 per day', games: '4000+', rtp: '96.4%', os: 'Windows, Mac, iOS, Android', currencies: 'AUD', languages: 'English', payments: ['visa', 'mastercard', 'payid', 'osko', 'googlepay', 'applepay'], playLink: 'https://auspokies.net/affiliates/4158946', foundedYear: 2020, ownerCompany: 'ACE96AU Entertainment Pty Ltd', headquartersLocation: 'Sydney, Australia', monthlyPlayers: '210,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$28)' },
    ipay9: { name: 'iPay9', logo: '/casinos/ipay9.png', rating: 4.97, ratingCount: 188, tag: 'Top Rated', bonusLabel: 'Weekly Commission', bonus: 'Weekly Commission 7%', payoutTime: 'Instant - 2 hours', withdrawLimit: 'A$7,500 per day', games: '4500++', rtp: '95.8%', os: 'Windows, Mac, Android, iOS', currencies: 'AUD', languages: 'English', payments: ['applepay', 'googlepay', 'visa', 'mastercard', 'payid', 'osko', 'crypto'], playLink: 'https://auspokies.net/affiliates/4158946', foundedYear: 2021, ownerCompany: 'iPay9 Entertainment Pty Ltd', headquartersLocation: 'Melbourne, Australia', monthlyPlayers: '245,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$50)' },
    kingbet9: { name: 'Kingbet9', logo: '/casinos/kingbet9.png', rating: 4.92, ratingCount: 219, tag: "Editor's Choice", bonusLabel: 'Daily Bonus', bonus: 'Unlimited Random Bonus', payoutTime: '1-3 hours', withdrawLimit: 'A$9,000 per day', games: '4000+', rtp: '95.9%', os: 'Android, iOS, Web', currencies: 'AUD', languages: 'English', payments: ['payid', 'visa', 'mastercard', 'ripple', 'usdt'], playLink: 'https://auspokies.net/affiliates/4499886', foundedYear: 2020, ownerCompany: 'Kingbet9 Gaming Pty Ltd', headquartersLocation: 'Brisbane, Australia', monthlyPlayers: '230,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$28)' },
    bigpay77: { name: 'Bigpay77', logo: '/casinos/bigpay77.png', rating: 4.90, ratingCount: 167, tag: 'Most Popular', bonusLabel: 'Welcome Bonus', bonus: 'Welcome Bonus 80%', payoutTime: '1-6 hours', withdrawLimit: 'A$22,000 per month', games: '5500+', rtp: '95.7%', os: 'Android, iOS, Web', currencies: 'AUD', languages: 'English', payments: ['payid', 'osko', 'speedpay', 'amopay', 'visa'], playLink: 'https://auspokies.net/affiliates/2392349', foundedYear: 2019, ownerCompany: 'Bigpay77 Entertainment Pty Ltd', headquartersLocation: 'Perth, Australia', monthlyPlayers: '220,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$28)' },
    me99: { name: 'Me99', logo: '/casinos/me99.png', rating: 4.86, ratingCount: 468, tag: "Player's Favorite", bonusLabel: 'Daily Rebate', bonus: '5% Rebate Bonus', payoutTime: '1-3 hours', withdrawLimit: 'A$30,000 per month', games: '4500++', rtp: '96.1%', os: 'Android, iOS, Web', currencies: 'AUD', languages: 'English', payments: ['visa', 'mastercard', 'payid', 'speedpay', 'amopay'], playLink: 'https://auspokies.net/affiliates/2392349', foundedYear: 2022, ownerCompany: 'Me99 Interactive Pty Ltd', headquartersLocation: 'Sydney, Australia', monthlyPlayers: '240,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$50)' },
    rolex9: { name: 'Rolex9', logo: '/casinos/rolex9.png', rating: 4.96, ratingCount: 276, tag: 'High Roller Pick', bonusLabel: 'Welcome Bonus', bonus: 'Slot Welcome Bonus 50%', payoutTime: 'Instant - 1 hour', withdrawLimit: 'A$4,500 per day', games: '4500++', rtp: '95.6%', os: 'Android, iOS', currencies: 'AUD', languages: 'English', payments: ['payid', 'osko', 'visa', 'mastercard'], playLink: 'https://auspokies.net/affiliates/1722773', foundedYear: 2019, ownerCompany: 'Rolex9 Digital Pty Ltd', headquartersLocation: 'Melbourne, Australia', monthlyPlayers: '180,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$29)' },
    gucci9: { name: 'Gucci9', logo: '/casinos/gucci9.png', rating: 4.88, ratingCount: 399, tag: 'High Rebates', bonusLabel: 'Random Bonus', bonus: 'Every Deposit Random Bonus', payoutTime: '15 minutes - 3 hours', withdrawLimit: 'A$8,000 per day', games: '4000+', rtp: '96.0%', os: 'Android, iOS, Windows', currencies: 'AUD', languages: 'English', payments: ['visa', 'mastercard', 'applepay', 'googlepay', 'speedpay'], playLink: 'https://auspokies.net/affiliates/2148247', foundedYear: 2021, ownerCompany: 'Gucci9 Interactive Pty Ltd', headquartersLocation: 'Brisbane, Australia', monthlyPlayers: '205,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$50)' },
    mrbean9: { name: 'MrBean9', logo: '/casinos/mrbean9.png', rating: 4.92, ratingCount: 301, tag: 'Best for Pokies', bonusLabel: 'Daily Bonus', bonus: 'Daily First Deposit 30%', payoutTime: '1-6 hours', withdrawLimit: 'A$20,000 per month', games: '4000+', rtp: '95.7%', os: 'Windows, Mac, Android', currencies: 'AUD', languages: 'English', payments: ['visa', 'mastercard', 'googlepay', 'applepay', 'osko'], playLink: 'https://auspokies.net/affiliates/2392349', foundedYear: 2020, ownerCompany: 'MrBean9 Gaming Pty Ltd', headquartersLocation: 'Adelaide, Australia', monthlyPlayers: '190,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$28)' },
    pkm9: { name: 'PKM9', logo: '/casinos/pkm9.png', rating: 4.80, ratingCount: 365, tag: 'Fastest Payouts', bonusLabel: 'Daily Bonus', bonus: 'Daily Slot Bonus 80%', payoutTime: '1-6 hours', withdrawLimit: 'A$25,000 per month', games: '4500++', rtp: '96.2%', os: 'Windows, Mac, Android, iOS', currencies: 'AUD', languages: 'English', payments: ['payid', 'osko', 'visa', 'mastercard', 'btc', 'eth'], playLink: 'https://auspokies.net/affiliates/4499886', foundedYear: 2022, ownerCompany: 'PKM9 Interactive Pty Ltd', headquartersLocation: 'Perth, Australia', monthlyPlayers: '175,000+', minDeposit: 'A$8', minWithdrawal: 'No Limit (min. A$28)' },
    winnie777: { name: 'Winnie777', logo: '/casinos/winnie777.png', rating: 4.72, ratingCount: 243, tag: 'Bonuses Packed', bonusLabel: 'Free Credit', bonus: 'Free Credit 365 Days', payoutTime: '15 minutes - 6 hours', withdrawLimit: 'A$15,000 per month', games: '5500+', rtp: '96.0%', os: 'Windows, Mac, Android, iOS', currencies: 'AUD', languages: 'English', payments: ['visa', 'mastercard', 'payid', 'speedpay', 'googlepay'], playLink: 'https://auspokies.net/affiliates/2148247', foundedYear: 2019, ownerCompany: 'Winnie777 Digital Pty Ltd', headquartersLocation: 'Sydney, Australia', monthlyPlayers: '165,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$18)' },
    micky9: { name: 'Micky9', logo: '/casinos/micky9.png', rating: 4.83, ratingCount: 332, tag: 'Mobile Friendly', bonusLabel: 'Weekly Commission', bonus: 'Weekly Commission 5%', payoutTime: 'Instant', withdrawLimit: 'A$6,000 per day', games: '5500+', rtp: '95.8%', os: 'Android, iOS, Web', currencies: 'AUD', languages: 'English', payments: ['visa', 'mastercard', 'payid', 'amopay', 'speedpay'], playLink: 'https://auspokies.net/affiliates/4158946', foundedYear: 2021, ownerCompany: 'Micky9 Entertainment Pty Ltd', headquartersLocation: 'Adelaide, Australia', monthlyPlayers: '150,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$30)' },
    bybid9: { name: 'Bybid9', logo: '/casinos/bybid9.png', rating: 4.75, ratingCount: 421, tag: 'Premium Jackpot', bonusLabel: 'Daily Bonus', bonus: 'Daily Easy Step Free 100', payoutTime: 'Instant - 2 hours', withdrawLimit: 'A$18,000 per month', games: '5500+', rtp: '95.9%', os: 'Windows, Mac, Android, iOS', currencies: 'AUD', languages: 'English', payments: ['payid', 'osko', 'visa', 'mastercard', 'ripple', 'usdt'], playLink: 'https://auspokies.net/affiliates/1722773', foundedYear: 2020, ownerCompany: 'Bybid9 Gaming Pty Ltd', headquartersLocation: 'Melbourne, Australia', monthlyPlayers: '185,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$50)' },
    queen13: { name: 'Queen13', logo: '/casinos/queen13.png', rating: 4.89, ratingCount: 149, tag: 'Best for Pokies', bonusLabel: 'Welcome Bonus', bonus: 'Slot Welcome Bonus 50%', payoutTime: '15 minutes - 1 day', withdrawLimit: 'A$10,000 per month', games: '4000+', rtp: '95.6%', os: 'Windows, Android, iOS', currencies: 'AUD', languages: 'English', payments: ['visa', 'mastercard', 'payid', 'googlepay', 'applepay'], playLink: 'https://auspokies.net/affiliates/1722773', foundedYear: 2022, ownerCompany: 'Queen13 Interactive Pty Ltd', headquartersLocation: 'Brisbane, Australia', monthlyPlayers: '170,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$50)' },
  };
  ...
  const buildFullTemplateCasino = (slugValue: string, source: (typeof comingSoonCasinoMap)[string]): CasinoDetail => ({
    ...
    minWithdrawal: source.minWithdrawal,
    liveChat: true,
    emailSupport: true,
    phoneSupport: false,
