...
export default function CasinoReviewPage() {
  ...
  const comingSoonCasinoMap: Record<string, {
    ...
    ace96au: { name: 'ACE96AU', logo: '/casinos/ace96au.png', rating: 4.85, ratingCount: 512, tag: 'New Launch', bonusLabel: 'VIP Bonus', bonus: '100% VVIP Bonus', payoutTime: 'Instant', withdrawLimit: 'A$50,000 - A$100,000', games: '4000+', rtp: '96.4%', os: 'Windows, Mac, iOS, Android', currencies: 'AUD', languages: 'English', payments: ['visa', 'mastercard', 'payid', 'osko', 'googlepay', 'applepay'], playLink: 'https://auspokies.net/affiliates/4158946', foundedYear: 2020, ownerCompany: 'ACE96AU Entertainment Pty Ltd', headquartersLocation: 'Sydney, Australia', monthlyPlayers: '210,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$28)' },
    ...
    me99: { name: 'Me99', logo: '/casinos/me99.png', rating: 4.86, ratingCount: 468, tag: "Player's Favorite", bonusLabel: 'Daily Rebate', bonus: '5% Rebate Bonus', payoutTime: '1-3 hours', withdrawLimit: 'A$100,000', games: '4500++', rtp: '96.1%', os: 'Android, iOS, Web', currencies: 'AUD', languages: 'English', payments: ['visa', 'mastercard', 'payid', 'speedpay', 'amopay'], playLink: 'https://auspokies.net/affiliates/2392349', foundedYear: 2022, ownerCompany: 'Me99 Interactive Pty Ltd', headquartersLocation: 'Sydney, Australia', monthlyPlayers: '240,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$50)' },
    rolex9: { name: 'Rolex9', logo: '/casinos/rolex9.png', rating: 4.96, ratingCount: 276, tag: 'High Roller Pick', bonusLabel: 'Welcome Bonus', bonus: 'Slot Welcome Bonus 50%', payoutTime: 'Instant - 1 hour', withdrawLimit: 'A$100,000', games: '4500++', rtp: '95.6%', os: 'Android, iOS', currencies: 'AUD', languages: 'English', payments: ['payid', 'osko', 'visa', 'mastercard'], playLink: 'https://auspokies.net/affiliates/1722773', foundedYear: 2019, ownerCompany: 'Rolex9 Digital Pty Ltd', headquartersLocation: 'Melbourne, Australia', monthlyPlayers: '180,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$29)' },
    ...
    mrbean9: { name: 'MrBean9', logo: '/casinos/mrbean9.png', rating: 4.92, ratingCount: 301, tag: 'Best for Pokies', bonusLabel: 'Daily Bonus', bonus: 'Daily First Deposit 30%', payoutTime: '1-6 hours', withdrawLimit: 'A$50,000 - A$100,000', games: '4000+', rtp: '95.7%', os: 'Windows, Mac, Android', currencies: 'AUD', languages: 'English', payments: ['visa', 'mastercard', 'googlepay', 'applepay', 'osko'], playLink: 'https://auspokies.net/affiliates/2392349', foundedYear: 2020, ownerCompany: 'MrBean9 Gaming Pty Ltd', headquartersLocation: 'Adelaide, Australia', monthlyPlayers: '190,000+', minDeposit: 'A$10', minWithdrawal: 'No Limit (min. A$28)' },
