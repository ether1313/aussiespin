  ...
  const casinos: Casino[] = [
    {
      ...
      payoutTime: "Instant - 12 hours", withdrawLimit: "A$50,000 - A$100,000",
      games: "4000+", os: "Windows, Mac, iOS, Android", rtp: "97.4%",
      currencies: "AUD",
      languages: "English",
    ...
    {
      id: 2, rank: 2, name: "MrBoom9",
      logo: "/casinos/mrboom9.png",
      rating: 4.97, ratingCount: 599,
      bonus: "Register Free Credit $99.99", bonusLabel: "Free Credit",
      payoutTime: "Instant - 12 hours", withdrawLimit: "A$50,000 - A$100,000",
      games: "4500++", os: "Windows, Mac, Android, iOS", rtp: "97.1%",
      currencies: "AUD",
      languages: "English",
      payments: ["visa", "mastercard", "google-pay", "apple-pay", "payid", "osko", "amopay", "speedpay"],
      reviewLink: "/mrboom9", playLink: "https://mrboom9.com/RFAUSSIESPINNNN",
      tag: "Hot Bonus"
    },
    {
      id: 3, rank: 3, name: "iPay9",
      logo: "/casinos/ipay9.png",
      rating: 4.96, ratingCount: 688,
      bonus: "Weekly Commission 7%", bonusLabel: "Weekly Commission",
      payoutTime: "Instant - 12 hours", withdrawLimit: "A$300,000",
      games: "4500++", os: "Windows, Mac, Android, iOS", rtp: "96.7%",
      currencies: "AUD",
      languages: "English",
      payments: ["visa", "mastercard", "google-pay", "apple-pay", "payid", "osko", "amopay", "speedpay"],
    ...
    {
      id: 4, rank: 4, name: "Kingbet9",
      logo: "/casinos/kingbet9.png",
      rating: 4.94, ratingCount: 619,
      bonus: "Unlimited Random Bonus", bonusLabel: "Daily Bonus",
      payoutTime: "Instant - 12 hours", withdrawLimit: "A$200,000",
      games: "4000+", os: "Android, iOS, Web", rtp: "96.2%",
      currencies: "AUD",
      languages: "English",
      payments: ["visa", "mastercard", "google-pay", "apple-pay", "payid", "osko", "amopay", "speedpay"],
    ...
    {
      id: 5, rank: 5, name: "BigPay77",
      logo: "/casinos/bigpay77.png",
      rating: 4.92, ratingCount: 567,
      bonus: "Welcome Bonus 80%", bonusLabel: "Welcome Bonus",
      payoutTime: "Instant - 12 hours", withdrawLimit: "A$200,000",
      games: "5500+", os: "Android, iOS, Web", rtp: "95.9%",
      currencies: "AUD",
      languages: "English",
      payments: ["visa", "mastercard", "google-pay", "apple-pay", "payid", "osko", "amopay", "speedpay"],
    ...
    {
      id: 6, rank: 6, name: "Me99",
      logo: "/casinos/me99.png",
      rating: 4.90, ratingCount: 468,
      bonus: "5% Rebate Bonus", bonusLabel: "Daily Rebate",
      payoutTime: "Instant - 12 hours", withdrawLimit: "A$100,000",
      games: "4500++", os: "Android, iOS, Web", rtp: "96.8%",
      currencies: "AUD",
      languages: "English",
      payments: ["visa", "mastercard", "google-pay", "apple-pay", "payid", "osko", "amopay", "speedpay"],
    ...
    {
      id: 7, rank: 7, name: "Rolex9",
      logo: "/casinos/rolex9.png",
      rating: 4.88, ratingCount: 676,
      bonus: "Slot Welcome Bonus 50%", bonusLabel: "Welcome Bonus",
      payoutTime: "Instant - 12 hours", withdrawLimit: "A$100,000",
      games: "4500++", os: "Android, iOS", rtp: "95.7%",
      currencies: "AUD",
      languages: "English",
      payments: ["visa", "mastercard", "google-pay", "apple-pay", "payid", "osko", "amopay", "speedpay"],
    ...
    {
      id: 8, rank: 8, name: "Gucci9",
      logo: "/casinos/gucci9.png",
      rating: 4.86, ratingCount: 569,
      bonus: "Every Deposit Random Bonus", bonusLabel: "Random Bonus",
      payoutTime: "Instant - 12 hours", withdrawLimit: "A$100,000",
      games: "4000+", os: "Android, iOS, Windows", rtp: "97.0%",
      currencies: "AUD",
      languages: "English",
      payments: ["visa", "mastercard", "google-pay", "apple-pay", "payid", "osko", "amopay", "speedpay"],
    ...
    {
      id: 9, rank: 9, name: "MrBean9",
      logo: "/casinos/mrbean9.png",
      rating: 4.84, ratingCount: 511,
      bonus: "Daily First Deposit 30%", bonusLabel: "Daily Bonus",
      payoutTime: "Instant - 12 hours", withdrawLimit: "A$50,000 - A$100,000",
      games: "4000+", os: "Windows, Mac, Android", rtp: "95.6%",
      currencies: "AUD",
      languages: "English",
      payments: ["visa", "mastercard", "google-pay", "apple-pay", "payid", "osko", "amopay", "speedpay"],
    ...
    {
      id: 10, rank: 10, name: "PKM9",
      logo: "/casinos/pkm9.png",
      rating: 4.82, ratingCount: 465,
      bonus: "Daily Slot Bonus 80%", bonusLabel: "Daily Bonus",
      payoutTime: "Instant - 12 hours", withdrawLimit: "A$50,000 - A$100,000",
      games: "4500++", os: "Windows, Mac, Android, iOS", rtp: "97.2%",
      currencies: "AUD",
      languages: "English",
      payments: ["visa", "mastercard", "google-pay", "apple-pay", "payid", "osko", "amopay", "speedpay"],
    ...
    {
      id: 11, rank: 11, name: "Winnie777",
      logo: "/casinos/winnie777.png",
      rating: 4.80, ratingCount: 343,
      bonus: "Free Credit 365 Days", bonusLabel: "Free Credit",
      payoutTime: "Instant - 12 hours", withdrawLimit: "A$50,000 - A$100,000",
      games: "5500+", os: "Windows, Mac, Android, iOS", rtp: "96.3%",
      currencies: "AUD",
      languages: "English",
      payments: ["visa", "mastercard", "google-pay", "apple-pay", "payid", "osko", "amopay", "speedpay"],
    ...
    {
      id: 13, rank: 13, name: "Bybid9",
      logo: "/casinos/bybid9.png",
      rating: 4.76, ratingCount: 621,
      bonus: "Daily Easy Step Free 100", bonusLabel: "Daily Bonus",
      payoutTime: "Instant - 12 hours", withdrawLimit: "A$20,000 per month",
      games: "5500+", os: "Windows, Mac, Android, iOS", rtp: "95.8%",
      currencies: "AUD",
      languages: "English",
      payments: ["visa", "mastercard", "google-pay", "apple-pay", "payid", "osko", "amopay", "speedpay"],
    ...
    {
      id: 14, rank: 14, name: "Queen13",
      logo: "/casinos/queen13.png",
      rating: 4.75, ratingCount: 549,
      bonus: "Slot Welcome Bonus 50%", bonusLabel: "Welcome Bonus",
      payoutTime: "Instant - 12 hours", withdrawLimit: "A$50,000 - A$100,000",
      games: "4000+", os: "Windows, Android, iOS", rtp: "95.4%",
      currencies: "AUD",
      languages: "English",
      payments: ["visa", "mastercard", "google-pay", "apple-pay", "payid", "osko", "amopay", "speedpay"],
